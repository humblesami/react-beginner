    ...
    return (
        <div className="footer-main bg6 p-l-45 p-r-45">
            <div className="flex-w">
                <div className="w-size6 p-t-20 p-l-15 p-r-15 respon3">
                ...
                <div className="w-size7 p-t-20 p-l-15 p-r-15 respon4">
                    <h4 className="s-text12 p-b-10">
                        Categories
                    </h4>
                ...
                <div className="w-size8 p-t-20 p-l-15 p-r-15 respon3">
                    <h4 className="s-text12 p-b-10">
                        Newsletter
                    </h4>
            ...
            <div className="t-center p-l-15 p-r-15">
                ...
                <a href="#">
                    <img className="h-size2" src={base_url + "images/icons/visa.png"} alt="IMG-VISA" />
                </a>

                <a href="#">
                    <img className="h-size2" src={base_url + "images/icons/mastercard.png"} alt="IMG-MASTERCARD" />
                </a>

                <a href="#">
                    <img className="h-size2" src={base_url + "images/icons/express.png"} alt="IMG-EXPRESS" />
                </a>
